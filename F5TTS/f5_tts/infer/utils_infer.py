...
from F5TTS.f5_tts.model import CFM
from F5TTS.f5_tts.model.utils import convert_char_to_pinyin, get_tokenizer
...
def load_model(
    ...
    if vocab_file == "":
        vocab_file = str(files("F5TTS.f5_tts").joinpath("infer/examples/vocab.txt"))
    tokenizer = "custom"
...
def preprocess_ref_audio_text(ref_audio_orig, ref_text, show_info=print):
    ...
    if not ref_text.strip():
        ...
        if audio_hash in _ref_text_cache:
            ...
            ref_text = accentizer.process_all(transcribe(ref_audio))
